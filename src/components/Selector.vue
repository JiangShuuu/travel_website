    ...
    <div class="websize">
      ...
      <div class="web_search">
              ...
              <defs>
                ...
                >
                  ...
                  <feBlend
                    ...
                    result="effect1_dropShadow_5806:6918"
                  />
                  <feBlend
                    mode="normal"
                    in="SourceGraphic"
        ...
        >
          ...
          <button type="submit" class="location">
...
import background1 from "./../assets/icon/旅遊.png";
import background2 from "./../assets/icon/住宿.png";
...
export default {
  ...
  methods: {
    changeBackground(path) {
      if (path === "/hotelFood") {
        this.backgroundPic = background2;
      } else {
        this.backgroundPic = background1;
      }
    },
    getCityArea(city) {
