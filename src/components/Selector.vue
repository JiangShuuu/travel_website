    ...
    <div class="websize">
      <div class="web">
        <!-- <div class="web_background">
          <img src="./../assets/icon/background.png" alt="" />
        </div> -->
...
.web {
  @include flexCenter;
  @include web {
    background-image: url("./../assets/icon/旅遊.png");
  ...
  &_search {
    ...
    .title {
      ...
      &_text {
        ...
        // text-shadow: 3px 3px 20px $pink, -2px 1px 30px #f179b5;
      }
    }
    &_bar {
      @include flexCenter;
